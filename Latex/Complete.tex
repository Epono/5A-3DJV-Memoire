...
\begin{figure}[!h]%
	\begin{center} 
		\includegraphics[width=0.60\columnwidth]{images/repeat2.png}%
		\caption{Why RPG NPCs Always Repeat Themselves, de Dorkly}%
	\end{center}
\end{figure}
...
Si dans certains jeux, cet aspect peut presque passer inaperçu (Fable), d’autres jeux reposent essentiellement sur ce principe (Evie).
...
Dans un premier temps, ils s’en sont servi pour chercher des motifs récurrents dans les phrases, puis, à l’aide de RNNLMs (Recurrent Neural Network Language Models), ils ont pu estimer les probabilités que tels mots se suivent, afin de former une phrase plus naturelle.
